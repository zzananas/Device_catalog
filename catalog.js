...
//         }
    ...
    // $(function(){
    //     $(".picture_wrap").mouseover(function(e) {
    //         $(this).find(".container__img").toggleClass("overlay")
    //             });
    //     $(".picture_wrap").mouseout(function(e) {
    //         $(this).find(".container__img").toggleClass("overlay")
    //       });
    ...
    //   $(function(){
    //     $(".picture_wrap").mouseover(function(e) {
    //         $(this).find(".picture").remove(".picture").addClass("overlay")
    //             });
    //     $(".picture_wrap").mouseout(function(e) {
    //         $(this).find(".picture").toggleClass("overlay")
    //       });
    ...
    $(function(){
        $(".checkbox_border").click(function(e) {
          $(this).find(".checked_svg").toggleClass("active");
        });
        $(".checkbox_radio").click(function(e) {
            $(this).find(".checked_svg").toggleClass("active");
          });
      });
